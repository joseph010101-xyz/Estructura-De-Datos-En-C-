...
void __fastcall TForm1::Button1Click(TObject *Sender)
{
	...
	fecha->SetAño(StrToInt(EditAño->Text));
}
//---------------------------------------------------------------------------
...
{
	fecha->SetAño(StrToInt(EAño1->Text));
...
{
	fechaDos->SetAño(StrToInt(EAño2->Text));
...
{
    EResultado->Text=fecha->AñoBisiesto(StrToInt(EAñoBisiesto->Text));
}
//---------------------------------------------------------------------------
...
{
    EResultado->Text=fecha->EstacionDelAño();
}
//---------------------------------------------------------------------------
...
void __fastcall TForm1::Button16Click(TObject *Sender)
{
	...
	fechaOriginal.SetAño(StrToInt(EditAño->Text));
	CFecha fechaCopia=fechaOriginal.Copia();
	ShowMessage("Fecha copiada:"+IntToStr(fechaCopia.GetDia())+"/"+IntToStr(fechaCopia.GetMes())+"/"+IntToStr(fechaCopia.GetAño()));
}
//---------------------------------------------------------------------------
...
void __fastcall TForm1::Button18Click(TObject *Sender)
{
	CFecha fecha1;
	CFecha fecha2;
	fecha1.SetAño(StrToInt(EAño1->Text));
	fecha1.SetMes(StrToInt(EMes1->Text));
	fecha1.SetDia(StrToInt(EDia1->Text));

	fecha2.SetAño(StrToInt(EAño2->Text));
